...
func TestEndpointsMapFromESC(t *testing.T) {
	testCases := map[string]struct {
		...
		"2 slices, overlapping endpoints, some endpoints unready in 1 or both": {
			...
			expectedMap: map[ServicePortName][]*BaseEndpointInfo{
				makeServicePortName("ns1", "svc1", "port-0", v1.ProtocolTCP): {
					...
					&BaseEndpointInfo{Endpoint: "10.0.1.6:80", NotReady: true},
		...
		"2 slices, overlapping endpoints, all unready": {
			...
			expectedMap: map[ServicePortName][]*BaseEndpointInfo{
				makeServicePortName("ns1", "svc1", "port-0", v1.ProtocolTCP): {
					&BaseEndpointInfo{Endpoint: "10.0.1.10:80", NotReady: true},
					&BaseEndpointInfo{Endpoint: "10.0.1.1:80", NotReady: true},
					&BaseEndpointInfo{Endpoint: "10.0.1.2:80", NotReady: true},
					&BaseEndpointInfo{Endpoint: "10.0.1.3:80", NotReady: true},
					&BaseEndpointInfo{Endpoint: "10.0.1.4:80", NotReady: true},
					&BaseEndpointInfo{Endpoint: "10.0.1.5:80", NotReady: true},
					&BaseEndpointInfo{Endpoint: "10.0.1.6:80", NotReady: true},
					&BaseEndpointInfo{Endpoint: "10.0.1.7:80", NotReady: true},
					&BaseEndpointInfo{Endpoint: "10.0.1.8:80", NotReady: true},
					&BaseEndpointInfo{Endpoint: "10.0.1.9:80", NotReady: true},
				},
			},
		},
